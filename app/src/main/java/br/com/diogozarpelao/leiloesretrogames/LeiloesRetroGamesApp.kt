...
@Composable
internal fun LeiloesRetroGamesApp(
    application: AuctionApplication,
    notificationScheduler: AuctionNotificationScheduler
) {
    ...
    var showAddAuctionScreen by
        rememberSaveable {
            mutableStateOf(false)
        }

    var selectedAuctionId by
        rememberSaveable {
            mutableStateOf<Long?>(null)
        }

    var editingAuctionId by
        rememberSaveable {
            mutableStateOf<Long?>(null)
        }

    var selectedAuctionSection by
        rememberSaveable {
            mutableStateOf(
